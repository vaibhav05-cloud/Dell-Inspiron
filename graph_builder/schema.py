"""
graph_builder/schema.py  — UPDATED

Added PRODUCES + other types from Vaibhav's extractor to VALID_RELATIONSHIP_TYPES.
Everything else is identical to teammate's original.
"""
...
VALID_RELATIONSHIP_TYPES = frozenset({
    ...
    "LOCATED_IN",
    "CUSTOM",
    # ── Added: Vaibhav's extractor types (via output_adapter.py mapping) ──────
    "PRODUCES",        # Dell PRODUCES Inspiron  — too meaningful to lose
})
